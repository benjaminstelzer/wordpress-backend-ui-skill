...
Read only after demonstrating a missing native relationship and checking
available markup, classes and component APIs. None of these values is a Classic
compliance target. Do not apply them over native margins or use them to judge
an existing native paragraph, Notice, table or control.

## Skill-Norm choices for an owner gap
